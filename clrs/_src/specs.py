...
SPECS = types.MappingProxyType({
    ...
    'karger_prim': {
        ...
        'u': (Stage.HINT, Location.NODE, Type.MASK_ONE),
        'phase': (Stage.HINT, Location.GRAPH, Type.CATEGORICAL),
        'max_edge': (Stage.HINT, Location.GRAPH, Type.SCALAR),
        'group_rep': (Stage.HINT, Location.NODE, Type.MASK_ONE),
    },
    'karger_kruskal': {
        'pos': (Stage.INPUT, Location.NODE, Type.SCALAR),
        'A': (Stage.INPUT, Location.EDGE, Type.SCALAR),
        'adj': (Stage.INPUT, Location.EDGE, Type.MASK),
        'components': (Stage.INPUT, Location.NODE, Type.MASK_ONE),
        'zero': (Stage.INPUT, Location.NODE, Type.MASK_ONE),
        'pi_final': (Stage.OUTPUT, Location.NODE, Type.POINTER),
        ...
        'phase': (Stage.HINT, Location.GRAPH, Type.CATEGORICAL),
        'components_h': (Stage.HINT, Location.NODE, Type.MASK_ONE),
        'zero_h': (Stage.HINT, Location.NODE, Type.MASK_ONE)
    },
    'insertion_sort': {
        'pos': (Stage.INPUT, Location.NODE, Type.SCALAR),
